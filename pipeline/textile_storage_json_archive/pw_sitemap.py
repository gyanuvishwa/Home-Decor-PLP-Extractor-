...
with sync_playwright() as p:
    ...
    resp = page.goto("https://www.zarahome.com/8/info/sitemaps/sitemap-index-home-categories-zh.xml", timeout=30000)
    print("sitemap index status:", resp.status if resp else None)
    body = page.content()
